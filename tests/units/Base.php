...
abstract class Base extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $command = 'php vendor/bin/phinx --configuration=tests/phinx.php migrate -e '.DB_DRIVER.';';
        $command .= 'php vendor/bin/phinx --configuration=tests/phinx.php seed:run -e '.DB_DRIVER.';';
