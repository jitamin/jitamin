...
class TaskExternalLinkTest extends Base
{
    public function testCreate()
    {
        ...
        $this->assertEquals(1, $taskExternalLinkModel->create(array('task_id' => 1, 'id' => '', 'url' => 'https://hiject.net/', 'title' => 'My website', 'link_type' => 'weblink', 'dependency' => 'related')));
    ...
    public function testModification()
    {
        ...
        $this->assertTrue($taskExternalLinkModel->update(array('id' => 1, 'url' => 'https://hiject.net/')));
    ...
    public function testGetAll()
    {
        ...
        $this->assertEquals(2, $taskExternalLinkModel->create(array('task_id' => 1, 'url' => 'https://hiject.net/', 'title' => 'KB', 'link_type' => 'weblink', 'dependency' => 'related')));
