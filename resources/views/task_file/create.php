...
<div id="file-done" style="display:none">
    <p class="alert alert-success">
        ...
        <?= $this->url->link(t('View uploaded files'), 'TaskController', 'show', ['task_id' => $task['id'], 'project_id' => $task['project_id']]) ?>
    </p>
</div>
...
<div
    ...
    data-url="<?= $this->url->href('TaskFileController', 'store', ['task_id' => $task['id'], 'project_id' => $task['project_id']]) ?>">
