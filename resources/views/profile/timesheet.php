...
<?php else: ?>
    <table class="table-fixed table-scrolling table-striped">
        ...
        <tr>
            <td><?= $this->url->link($this->text->e($record['task_title']), 'TaskViewController', 'show', ['project_id' => $record['project_id'], 'task_id' => $record['task_id']]) ?></td>
            <td><?= $this->url->link($this->text->e($record['subtask_title']), 'TaskViewController', 'show', ['project_id' => $record['project_id'], 'task_id' => $record['task_id']]) ?></td>
