    ...
    <?php else: ?>
        ...
        <?php else: ?>
            <table id="board"
                   ...
                   data-save-url="<?= $this->url->href('BoardAjaxController', 'save', ['project_id' => $project['id']]) ?>"
                   ...
                   data-task-creation-url="<?= $this->url->href('TaskCreationController', 'show', ['project_id' => $project['id']]) ?>"
            >
        <?php endif ?>
