        ...
        <div class="board-column-expanded">
            <?php if (!$not_editable && $this->projectRole->canCreateTaskInColumn($column['project_id'], $column['id'])): ?>
                <div class="board-add-icon">
                    <?= $this->url->link('+', 'TaskController', 'create', ['project_id' => $column['project_id'], 'column_id' => $column['id'], 'swimlane_id' => $swimlane['id']], false, 'popover', t('Add a new task')) ?>
                </div>
            <?php endif ?>
                        ...
                        <ul>
                            ...
                            <?php if ($this->projectRole->canCreateTaskInColumn($column['project_id'], $column['id'])): ?>
                                <li>
                                    ...
                                    <?= $this->url->link(t('Create tasks in bulk'), 'TaskBulkController', 'show', ['project_id' => $column['project_id'], 'column_id' => $column['id'], 'swimlane_id' => $swimlane['id']], false, 'popover') ?>
                                </li>
                            <?php endif ?>
