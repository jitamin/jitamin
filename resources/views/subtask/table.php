<?php if (!empty($subtasks)): ?>
    <table
        ...
        data-save-position-url="<?= $this->url->href('Task/SubtaskController', 'movePosition', ['project_id' => $task['project_id'], 'task_id' => $task['id']]) ?>"
    >
    <thead>
        <tr>
                ...
                <ul class="no-bullet">
                    ...
                    <li>
                        <?php if ($subtask['is_timer_started']): ?>
                            ...
                            <?= $this->url->link(t('Stop timer'), 'Task/SubtaskStatusController', 'timer', ['timer' => 'stop', 'project_id' => $task['project_id'], 'task_id' => $subtask['task_id'], 'subtask_id' => $subtask['id']], false, 'subtask-toggle-timer') ?>
                            (<?= $this->dt->age($subtask['timer_start_date']) ?>)
                        <?php else: ?>
                            <i class="fa fa-play-circle-o"></i>
                            <?= $this->url->link(t('Start timer'), 'Task/SubtaskStatusController', 'timer', ['timer' => 'start', 'project_id' => $task['project_id'], 'task_id' => $subtask['task_id'], 'subtask_id' => $subtask['id']], false, 'subtask-toggle-timer') ?>
                        <?php endif ?>
                    </li>
                    <?php endif ?>
                </ul>
