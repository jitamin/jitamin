                    ...
                    <ul>
                        <?php if ($has_project_creation_access): ?>
                            <li><i class="fa fa-cube"></i>
                                <?= $this->url->link(t('New project'), 'Project/ProjectController', 'create', [], false, 'popover medium') ?>
                            </li>
                        <?php endif ?>
                        <?php if ($is_private_project_enabled): ?>
                            <li>
                                <i class="fa fa-lock"></i>
                                <?= $this->url->link(t('New private project'), 'Project/ProjectController', 'createPrivate', [], false, 'popover medium') ?>
                            </li>
                        <?php endif ?>
                        ...
                        <li>
                            ...
                            <?= $this->url->link(t('New task'), 'Task/TaskSimpleController', 'create', [], false, 'popover medium') ?>
                        </li>
                        <?php endif ?>
