...
<section>
<form method="post" action="<?= $this->url->href('SettingController', 'store', ['redirect' => 'webhook']) ?>" autocomplete="off">
...
<section class="listing">
    <ul>
        ...
        <li>
            <?= $this->url->link(t('Reset token'), 'SettingController', 'token', ['type' => 'webhook'], true) ?>
        </li>
    </ul>
</section>
