...
<form class="popover-form" method="post" action="<?= $this->url->href('TaskModificationController', 'update', ['task_id' => $task['id'], 'project_id' => $task['project_id']]) ?>" autocomplete="off">
    <?= $this->form->csrf() ?>
