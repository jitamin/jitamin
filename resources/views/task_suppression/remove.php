...
<div class="confirm">
    ...
    <div class="form-actions">
        <?= $this->url->link(t('Confirm'), 'TaskSuppressionController', 'remove', ['task_id' => $task['id'], 'project_id' => $task['project_id'], 'redirect' => $redirect], true, 'btn btn-danger popover-link') ?>
        <?= t('or') ?>
