...
<div class="confirm">
    ...
    <div class="form-actions">
        <?= $this->url->link(t('Confirm'), 'Project/ProjectRoleRestrictionController', 'remove', ['project_id' => $project['id'], 'restriction_id' => $restriction['restriction_id']], true, 'btn btn-danger') ?>
