...
<form action="<?= $this->url->href('Task/TaskImportController', 'store', ['project_id' => $project['id']]) ?>" method="post" enctype="multipart/form-data">
    <?= $this->form->csrf() ?>
...
<p><i class="fa fa-download fa-fw"></i><?= $this->url->link(t('Download CSV template'), 'Task/TaskImportController', 'template', ['project_id' => $project['id']]) ?></p>
