...
<div id="file-done" style="display:none">
    <p class="alert alert-success">
        ...
        <?= $this->url->link(t('View uploaded files'), 'ProjectViewController', 'show', array('project_id' => $project['id'])) ?>
    </p>
</div>
...
<div class="form-actions">
    ...
    <?= t('or') ?>
    <?= $this->url->link(t('cancel'), 'ProjectViewController', 'show', array('project_id' => $project['id']), false, 'btn btn-default close-popover') ?>
</div>
