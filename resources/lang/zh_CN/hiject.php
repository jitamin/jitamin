...
return [
    ...
    'All tasks of the column "%s" and the swimlane "%s" have been closed successfully.' => '位于 "%s(%s)" 下的所有任务已关闭',
    'Do you really want to close all tasks of this column?' => '你确定要关闭此任务栏下的所有任务？',
    '%d task(s) in the column "%s" and the swimlane "%s" will be closed.' => '%d 条位于 "%s(%s)" 下的任务将被关闭。',
