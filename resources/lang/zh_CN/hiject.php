...
return [
    ...
    'Remote user' => '绑定用户',
    'Remote users do not store their password in Hiject database, examples: LDAP, Google and Github accounts.' => '绑定用户不会在数据库中保存密码，例如：LDAP,GOOGLE,GitHub。',
    ...
    'Password Reset for Hiject' => '重置密码',
    ...
    'Example: http://example.hiject.com/ (used to generate absolute URLs)' => '例如： http://example.hiject.com/（用于生成绝对地址）',
    'Example: Hiject (used to show on the navbar)' => '例如: Hiject (在导航显示的系统名称)',
    ...
    'An update is available!' => 'Hiject有新版本发布!',
