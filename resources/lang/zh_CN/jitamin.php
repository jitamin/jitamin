...
return [
    ...
    'Notification' => '通知',
    '%s moved the task #%d to the first swimlane' => '%s 将任务 #%d 移动到了首个里程碑',
    'Swimlane' => '里程碑',
    'Gravatar' => 'Gravatar头像',
    '%s moved the task %s to the first swimlane' => '%s 将任务 %s 移动到了首个里程碑',
    '%s moved the task %s to the swimlane "%s"' => '%s 将任务 %s 移动到了里程碑 "%s" 下',
    ...
    'Swimlane changed for task #%d' => '任务 #%d 的里程碑已变更',
    ...
    'There is no column or swimlane activated in your project!' => '该项目暂无激活的任务栏和里程碑',
