...
class SettingsController extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->response->html($this->helper->layout->settings('settings/application', [
    ...
    public function email()
    {
        ...
        $this->response->html($this->helper->layout->settings('settings/email', [
            'values'          => $values,
            'mail_transports' => $this->emailClient->getAvailableTransports(),
    ...
    {
        $this->response->html($this->helper->layout->settings('settings/project', [
    ...
    {
        $this->response->html($this->helper->layout->settings('settings/board', [
    ...
    {
        $this->response->html($this->helper->layout->settings('settings/calendar', [
    ...
    {
        $this->response->html($this->helper->layout->settings('settings/integrations', [
    ...
    {
        $this->response->html($this->helper->layout->settings('settings/webhook', [
    ...
    public function api()
    {
        $this->response->html($this->helper->layout->settings('settings/api', [
